...
_EXTERN_ FILE *binaryfile, *threebbfile, *threebbprobabilityfile, *lightcollisionfile, *threebbdebugfile, *binintfile, *collisionfile, *pulsarfile, *morepulsarfile, *morecollfile, *triplefile, *tidalcapturefile, *semergedisruptfile, *removestarfile, *relaxationfile, *masslessremnantsfile;
